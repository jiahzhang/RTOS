...
void ST7735_Message(uint32_t  d, uint32_t  l, char *pt, int32_t value){
  // write this as part of Labs 1 and 2
    ...
    // clear line then draw
    ST7735_FillRect(0, l*10 + 80, 128, 10, ST7735_BLACK);
		ST7735_DrawString(0, l + 8, pt, ST7735_YELLOW);
    ST7735_SetCursor(15, l + 8);
