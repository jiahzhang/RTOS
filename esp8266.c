...
Sema4Type ESPRxDataAvailable;
Sema4Type ESPTxRoomLeft;
...
// UART_ESP8266(_FBRD_R) = 26;   // FBRD = round(0.4028 * 64 ) = 26
  ...
  OS_InitSemaphore(&ESPRxDataAvailable, 0);
  OS_InitSemaphore(&ESPTxRoomLeft, FIFOSIZE);
}
